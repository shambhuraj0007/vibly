  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-secondary/10 to-background ">
      ...
      <main className="ml-0 md:ml-64 mt-16 p-8">
        <h1 className="text-3xl font-extrabold mb-8 text-primary drop-shadow">Friends Requests</h1>
        ...
        <h1 className="text-3xl font-extrabold mb-8 mt-12 text-secondary drop-shadow">People you may know</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {loading ? (
            <FriendCardSkeleton />
        ...
        <h1 className="text-3xl font-extrabold mb-8 mt-12 text-primary drop-shadow">Friends List</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {loading ? (
            <FriendCardSkeleton />
          ) : friends.length === 0 ? (
            ...
            friends.map((friend) => (
              <div key={friend._id} className="bg-white/80 dark:bg-[#232946cc] backdrop-blur-xl rounded-2xl shadow-xl p-6 flex flex-col items-center">
                <img
                ...
                />
                <div className="font-bold text-lg text-primary mt-2">{friend.username}</div>
