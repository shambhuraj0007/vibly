...
function Card({
  ...
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card/80 backdrop-blur-md text-card-foreground flex flex-col gap-6 rounded-2xl border border-border/60 py-8 shadow-xl transition-all duration-200 hover:shadow-2xl",
        className
      )}
      {...props} />
  );
